...
config = {
  "apiKey": "AIzaSyDpyzZBa3bfNYLyZBNmLuCFor0ysRDy2S8",
  "authDomain": "bkanoon-5080a.firebaseapp.com",
  "databaseURL": "https://bkanoon-5080a-default-rtdb.asia-southeast1.firebasedatabase.app",
  "projectId": "bkanoon-5080a",
  "storageBucket": "bkanoon-5080a.appspot.com",
  "messagingSenderId": "678216894493",
  "appId": "1:678216894493:web:b4f5c8c23120c061089ef4",
  "measurementId": "G-V8C84H2SZG"
}
...
def firebase1(id):
    storage = firebase.storage()
    try:
        storage.child(id).download(path="",filename="temp.txt")
...
uri = "mongodb+srv://codesters:EDSkBfyhu0Fx4NDl@cluster0.kpwzqyd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
