  ...
  return (
    <>
      ...
      <div className='certiListBox'>
        ...
        <div className="certiListLabel"><label htmlFor="">{props.certName.slice(0,7)+(props.certName.length>7?"...":"")}</label></div>
      </div>
      ...
      <ContextMenu id="same_unique_identifier">
        ...
        <MenuItem data={{ foo: 'bar' }} onClick={viewSummaryFunction}>
          View Summary
        </MenuItem>
      </ContextMenu>
    </>
